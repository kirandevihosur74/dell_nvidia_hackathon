...
/** Stub provider for ZeroClaw gateways. */
export const zeroClawProvider: GatewayProvider = {
  type: "zeroclaw",
  displayName: "ZeroClaw",
  defaultPort: 19200,
  storageKey: "zeroclaw_gateways",
  deviceName: "ZeroClaw.mobile",
  ...
  async buildConnectParams(_config: GatewayConfig, ctx: ConnectContext): Promise<Record<string, unknown>> {
    ...
    return {
      protocol: 1,
      client: { id: "zeroclaw-mobile", instanceId: ctx.instanceId },
