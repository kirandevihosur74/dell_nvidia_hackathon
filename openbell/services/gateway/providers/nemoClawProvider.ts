...
/** Stub provider for NemoClaw gateways. */
export const nemoClawProvider: GatewayProvider = {
  type: "nemoclaw",
  displayName: "NemoClaw",
  defaultPort: 19400,
  storageKey: "nemoclaw_gateways",
  deviceName: "NemoClaw.mobile",
  ...
  async buildConnectParams(_config: GatewayConfig, ctx: ConnectContext): Promise<Record<string, unknown>> {
    ...
    return {
      protocol: 1,
      client: { id: "nemoclaw-mobile", instanceId: ctx.instanceId },
