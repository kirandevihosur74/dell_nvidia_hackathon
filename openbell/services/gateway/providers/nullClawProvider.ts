...
/** Stub provider for NullClaw gateways. */
export const nullClawProvider: GatewayProvider = {
  type: "nullclaw",
  displayName: "NullClaw",
  defaultPort: 19100,
  storageKey: "nullclaw_gateways",
  deviceName: "NullClaw.mobile",
  ...
  async buildConnectParams(_config: GatewayConfig, ctx: ConnectContext): Promise<Record<string, unknown>> {
    ...
    return {
      protocol: 1,
      client: { id: "nullclaw-mobile", instanceId: ctx.instanceId },
